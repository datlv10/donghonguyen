<div class="chitiet-giapha">
    <div class="top-header">
        ...
        {if !empty($genealogy.relationship_description)}
            <div class="relationship-info">
                {$genealogy.relationship_description}
            </div>
        {/if}
    </div>
            ...
            <div class="header-info">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-12">
                        <div class="base">
                            <table class="table table-borderless table-striped table-genealogy">
                                <tbody>
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {if !empty($husband.full_name)}
                                            <a href="javascript:;" detail-genealogy data-id="{if !empty($husband.id)}{$husband.id}{/if}" title="Xem thông tin nhân vật">
                                                {$husband.full_name}
                                            </a>
                                        {/if}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {if !empty($wife.full_name)}
                                            <a href="javascript:;" detail-genealogy data-id="{if !empty($wife.id)}{$wife.id}{/if}" title="Xem thông tin nhân vật">
                                                {$wife.full_name}
                                            </a>
                                        {/if}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {if !empty($child.full_name)}
                                            <a href="javascript:;" detail-genealogy data-id="{if !empty($child.id)}{$child.id}{/if}" title="Xem thông tin nhân vật">
                                                {$child.full_name}
                                            </a>
                                        {/if}
                                    </td>
